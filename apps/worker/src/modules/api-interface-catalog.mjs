  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        access: "登录用户",
        example: { requestBody: { action: "delete", messageIds: ["msg_123", "msg_456"] } }
      },
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        access: "管理员",
        example: { requestBody: { expiresInDays: 30, targetRole: "member" } }
      },
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        access: "登录用户",
        example: { requestBody: { label: "个人 CLI", scopes: ["mail:read", "mail:send"] } }
      },
      {
        method: "DELETE",
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/api/notification/rules", title: "通知规则列表", description: "读取当前用户的 Webhook/Telegram/外部目标通知规则。", access: "登录用户" },
      {
        ...
        access: "登录用户",
        example: { requestBody: { name: "验证码通知", target: "webhook", eventTypes: ["message.received"], keyword: "code" } }
      },
      {
        method: "PUT",
